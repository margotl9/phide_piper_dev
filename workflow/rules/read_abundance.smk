...
rule build_viruses_bowtie2db:
    ...
    params:
		...
		extra_args=config["read_abundance"]["bowtie_build_extra_args"]
    conda:
        "../envs/kneaddata.yml"
...
rule bowtie2_align_reads_to_viruses:
    ...
    params:
        ...
        extra_args=config["read_abundance"]["bowtie_align_extra_args"]
...
rule build_viruses_kraken2db:
    ...
    params:
        ...
        extra_args=config["read_abundance"]["kraken2_extra_args"]
...
rule kraken2_align_reads_to_viruses:
    ...
    params:
        db=config["read_abundance"]["kraken_db"],
        extra_args=config["read_abundance"]["kraken_align_extra_args"]
...
rule bracken_build:
    ...
    params:
        db=config["read_abundance"]["kraken_db"],
        extra_args=config["read_abundance"]["bracken_build_extra_args"]
...
rule bracken:
    ...
    params:
        ...
        extra_args=config["read_abundance"]["bracken_extra_args"]
...
rule metapop:
    ...
    params:
        ...
        config["read_abundance"]["virus_dir"],
        ...
        extra_args=config["read_abundance"]["metapop_extra_args"],
...
rule inStrain_profile:
    ...
    params:
        ...
        min_breadth=config["virus_abundance"]["min_breadth"],
        extra_args=config["read_abundance"]["inStrain_profile_extra_args"]
...
rule inStrain_compare:
    ...
    params:
        ...
        extra_args=config["read_abundance"]["inStrain_compare_extra_args"]
